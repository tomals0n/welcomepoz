window.APP_DATA = {
    users: [
        ...
        { pin: '1234', name: 'Anna Kaczyńska', role: 'Kierownik' },
        ...
        { pin: '1122', name: 'Kamil Kowalski', role: 'Agent Lotniskowy' },
        { pin: '2211', name: 'Aleksandra Bondarenko', role: 'Agent Lotniskowy' }
    ],
    countriesData: [
    ...
    operationalData: {
        ...
        smartwings: [
            { title: 'Check-in opens', desc: 'TEST'}
        ]
    },
    airlineTiles: {
        ryanair: [
...
window.APP_DATA.openTopic = function({ topic, currentAirline, topicTitle, topicContent, showView, bindTopicAccordions }) {
